...
def get_trained_model(backbone : str = "ResNet50", fc_output_dim : int = 2048, normalize : bool = True) -> torch.nn.Module:
...
def EigenPlacesR50D2048(normalize=True):
    with contextlib.redirect_stdout(io.StringIO()), contextlib.redirect_stderr(
        ...
        model = get_trained_model(backbone="ResNet50", fc_output_dim=2048, normalize=normalize)
