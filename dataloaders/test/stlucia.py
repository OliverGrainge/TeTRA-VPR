...
class StLucia(Dataset):
    ...
    def __init__(
        ...
        self.dbImages = np.load(
            "dataloaders/image_paths/st_lucia_test_dbImages.npy", allow_pickle=True
        )
        self.qImages = np.load(
            "dataloaders/image_paths/st_lucia_test_qImages.npy", allow_pickle=True
        )
        self.ground_truth = np.load(
            "dataloaders/image_paths/st_lucia_test_gt.npy", allow_pickle=True
        )
