...
DATASET_ROOT = '/Users/olivergrainge/Documents/github/Datasets/inria_holidays/'
...
if not path_obj.exists():
    raise Exception(f'Please make sure the path {DATASET_ROOT} to Inria dataset is correct')
