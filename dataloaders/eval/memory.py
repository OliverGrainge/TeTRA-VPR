...
def get_floating_descriptor_size_bytes(model: torch.nn.Module, inputs: torch.Tensor) -> int:
...
def get_binary_descriptor_size_bytes(model: torch.nn.Module, inputs: torch.Tensor) -> float:
