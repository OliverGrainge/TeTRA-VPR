...
class EigenPlacesDataset(torch.utils.data.Dataset):
    def __init__(
        ...
        BASE_PATH = os.path.join(config["Datasets"]["datasets_dir"], "sf_xl/")
        ...
        if not os.path.exists(filename):
            ...
            self.initialize(BASE_PATH, M, N, min_images_per_class, filename)
    ...
    def __getitem__(self, class_num_idx):
        class_num = class_num_idx % len(self.classes_ids)
    ...
    def __len__(self):
        ...
        return self.get_images_num() * 1000
