...
class DataConfig:
    ...
    def add_argparse_args(parent_parser: ArgumentParser) -> ArgumentParser:
        ...
        group.add_argument("--val_dataset_dir", type=str, default=DataConfig.val_dataset_dir)
        group.add_argument("--train_dataset_dir", type=str, default=DataConfig.train_dataset_dir)
...
class ModelConfig:
    ...
    def add_argparse_args(parent_parser: ArgumentParser) -> ArgumentParser:
        ...
        group.add_argument("--backbone_arch", type=str, default=ModelConfig.backbone_arch)
...
class DistillConfig:
    ...
    pbar: bool = False
    checkpoint_dir: str = ""
    val_set_names: List[str] = ["Pitts30k_val"]

    
    @staticmethod
    def add_argparse_args(parent_parser: ArgumentParser) -> ArgumentParser:
        group = parent_parser.add_argument_group("Distillation")
        group.add_argument("--teacher_preset", type=str, default=DistillConfig.teacher_preset)
        ...
        group.add_argument("--mse_loss_mult", type=float, default=DistillConfig.mse_loss_mult)
        group.add_argument("--weight_decay_init", type=float, default=DistillConfig.weight_decay_init)
        group.add_argument("--weight_decay_schedule", type=str, default=DistillConfig.weight_decay_schedule)
        group.add_argument("--use_attention", type=bool, default=DistillConfig.use_attention)
        group.add_argument("--image_size", type=int, nargs=2, default=DistillConfig.image_size)
        group.add_argument("--augment_level", type=str, default=DistillConfig.augment_level)
        ...
        group.add_argument("--checkpoint_dir", type=str, default=DistillConfig.checkpoint_dir)
        return parent_parser
...
class TeTRAConfig:
    ...
    def add_argparse_args(parent_parser: ArgumentParser) -> ArgumentParser:
        ...
        group.add_argument("--miner_margin", type=float, default=TeTRAConfig.miner_margin)
        group.add_argument("--image_size", type=int, nargs=2, default=TeTRAConfig.image_size)
        group.add_argument("--augment_level", type=str, default=TeTRAConfig.augment_level)
        ...
        group.add_argument("--checkpoint_dir", type=str, default=TeTRAConfig.checkpoint_dir)
