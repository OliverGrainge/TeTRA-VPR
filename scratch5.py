...
sd = torch.load("/home/oliver/Downloads/ternary_vit_base_cls/version_8714/checkpoints/imagenet/ternary_vit_base_cls_epoch(85)_step(66220)_A1[74.1040]_A5[91.4000].ckpt")
sd = sd["state_dict"]
new_sd = {}
...
plt.axvline(w_abs_mean, color='blue', linestyle='--', label=f'wr.abs().mean() = {w_abs_mean:.4f}')
