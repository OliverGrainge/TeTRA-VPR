...
def main(args): 
    ...
    print(f"Image size: {args.img_height}x{args.img_width}, Dataset size: {args.dataset_size}")
    ...
    for i in range(num_iterations):
        ...
        print(f"Iteration {i+1}/{num_iterations}: Latency = {latency:.2f} ms, FPS = {fps:.2f}, Inference = {inference_latency:.2f} ms, Matching = {matching_latency:.2f} ms")
