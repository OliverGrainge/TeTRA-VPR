...
if __name__ == "__main__":
    sd = torch.load("checkpoints/TeTRA-finetune/VitbaseT224_BoQ-DescDividerFactor[1]/epoch=3-MSLS_val_q_R1=81.06.ckpt", map_location="cpu", weights_only=True)
    sd = sd["state_dict"]


    model = VitbaseT(image_size=[224, 224])
    model.eval()
